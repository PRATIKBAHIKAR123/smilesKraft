...
export default function DynamicMetadata() {
  ...
  const metadata = useMemo(() => {
    ...
    // Check if it's an urgent care service page
    else if (segments[0] === "urgent-care-services" && segments[1]) {
      const serviceKey = segments[1];
      if (
    ...
    // Check if it's a specific page (including SEO-optimized routes)
      ...
      // Try the full path first (for SEO-optimized routes like "patient-reviews-jerseycity-nj")
  ...
  useEffect(() => {
    const updateMetadata = () => {
      ...
      // Update canonical URL - ensure it's always the www version
