...
const features = [
  {
    ...
    title: "Skilled & Caring Team",
    desc: "Our experienced dentists and staff combine clinical expertise with a compassionate approach.",
  },
  {
    icon: "/Images/icons/perfect-teeth.png",
    title: "Emergency Care Without the Wait",
    desc: "Same-day appointments for urgent dental issues, so you get relief when you need it most.",
  },
  {
    icon: "/Images/icons/dental-chair.png",
    title: "Complete Care Under One Roof",
    desc: "From whitening and veneers to implants, orthodontics, and oral surgery - all your dental needs in one convenient location.",
  },
];
...
const team = [
  {
    ...
    time: "11 am - 03 pm",
    rating: 5.0,
    slug: "providers/manmeet-arora-jerseycity-nj-dentist",
  },
];
    ...
    <div className="w-full min-h-screen bg-background text-foreground font-sans overflow-x-hidden relative">
      <div className="details-page-header-section">
        <Fade direction="up" duration={1000}>
          <h1>About SmileKraft Dental, Jersey City</h1>
        </Fade>
        <Fade direction="down" duration={1000}>
          <h2 className="text-center">
             Modern Cosmetic & Family Dentistry for Every Stage of Life
          </h2>
        </Fade>
      </div>
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 py-8 sm:py-12 lg:py-16 px-4 sm:px-8 lg:px-16 max-w-7xl mx-auto">
        <div className="flex-1 space-y-4 sm:space-y-6 lg:pr-8 order-2 lg:order-1 w-full">
          ...
          <p>
            SmileKraft Dental delivers advanced family and cosmetic dentistry in Jersey City, NJ. Conveniently located on Martin Luther King Drive, our practice serves patients from{" "}
            <strong>
              <Link
                href="/service-areas/mcginley-square-nj-dentist-near-you"
                className="text-primary hover:underline font-medium"
              >
                Bergen-Lafayette (07304, 07305)
              </Link>
              ,{" "}
              <Link
                ...
                className="text-primary hover:underline font-medium"
              >
                McGinley Square (07304, 07306, 07302)
              </Link>
              ,{" "}
              <Link
            ...
            <Link
              ...
              className="text-primary hover:underline font-medium"
            >
              The Heights (07306, 07307)
            </Link>{" "}
            With a focus on preventive care, cosmetic enhancements, and same-day emergency dentistry, our team is dedicated to helping you achieve a healthy, confident smile.{" "}
          </p>

          <p>
            Our patients benefit from a full range of services, including preventive cleanings, restorative solutions, cosmetic enhancements, and{" "}
            <Link
              href="/providers"
              className="text-primary hover:underline font-medium"
            >
            ...
            care. With advanced technology and a focus on comfort, we ensure every visit is efficient and stress-free. Each treatment plan is tailored to your goals, giving you the confidence of a healthy, beautiful smile.{" "}
          </p>
        ...
        <div className="flex-1 flex justify-center lg:justify-end order-1 lg:order-2 w-full">
          ...
          <img
            ...
            alt="Dental checkup at SmileKraft Dental in Jersey City"
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8 py-8 sm:py-12 lg:py-16 px-4 sm:px-8 lg:px-16 max-w-7xl mx-auto">
        <div className="flex-1 flex justify-center lg:justify-start mb-6 lg:mb-0 order-2 lg:order-1 w-full">
          <img
            src="/Images/why patients choose.webp"
            alt="Trusted dental care at SmileKraft Dental in Jersey City"
            className="rounded-xl shadow-lg w-full max-w-sm sm:max-w-md lg:max-w-lg object-cover"
            loading="lazy"
          />
        </div>
        <div className="flex-1 lg:pl-12 order-1 lg:order-2">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-4 sm:mb-6 text-primary mt-2">
            Why Jersey City Families Trust SmileKraft Dental
          </h2>
          <p>
            At SmileKraft Dental, every detail of your visit is designed around comfort, precision, and results. Our state-of-the-art technology allows us to detect issues early and provide treatments that are both effective and minimally invasive. We go beyond fixing smiles - we focus on building lasting relationships and supporting your oral health at every stage of life.
          </p>
          <p className="mb-4 sm:mb-6">
            Patients from Bergen-Lafayette (07304, 07305), McGinley Square (07304, 07306, 07302), Greenville (07305), Journal Square (07306), and The Heights (07306, 07307) choose us because we offer:
          </p>
