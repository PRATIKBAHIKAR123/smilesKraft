...
export default function ServicesSection() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Professional whitening for brighter teeth",
    ...
    },
    {
      ...
      description: "Same-day urgent treatment",
    ...
    },
    {
      ...
      description: "Durable restorations for damaged teeth",
      ...
      href: "/services/crowns-and-bridges-jerseycity-nj",
    },
    {
      id: 5,
      title: "Root Canal Therapy",
      description: "Relieve pain and save teeth",
    ...
    },
    {
      ...
      description: "Safe removal with expert care",
    ...
    },
    {
      ...
      href: "/services/orthodontics-jerseycity-nj",
    },
  ];
    ...
    <section className="relative w-full mt-10 mx-auto px-4">
      ...
      <Fade delay={500}>
        <h3 className="text-center text-md md:text-2xl font-bold mb-5">
          <span className="font-medium">Quick Relief for Pain, Injuries & Dental Emergencies</span>
        </h3>
      </Fade>
      {/* <Fade delay={600}>
