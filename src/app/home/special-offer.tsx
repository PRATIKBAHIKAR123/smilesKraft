        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-3 md:p-8 border border-white/20">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              Multilingual Care for Our Patients
            </h3>
            ...
            <p className="text-lg mb-8 text-center text-white">
              No matter your language, our team is ready to make your visit comfortable and stress-free. Contact us today to book your appointment.
            </p>
