          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-start sm:items-center">
            <div className="relative order-1 lg:order-1 text-center sm:text-left">
              ...
              <div className="text-white space-y-2 sm:space-y-6 md:space-y-8 lg:space-y-8 p-2 sm:p-6 lg:p-8 relative z-10 mt-4 sm:mt-0">
                <div className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold leading-tight">
                  SmileKraft Dental
                </div>
                <p className="text-xs sm:text-base md:text-lg lg:text-xl text-white/80 max-w-lg leading-relaxed mx-auto sm:mx-0">
                  <span className="sm:hidden">
                    Jersey City’s Choice for Quality Family & 
                    <br />
                    Cosmetic Dentistry
                  </span>
                  <span className="hidden text-2xl sm:inline">
                    Jersey City’s Choice for Quality Family & Cosmetic Dentistry
                  </span>
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-3 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full sm:w-auto">
              <button
                onClick={() =>
                  window.open(
                    "https://maps.app.goo.gl/oHDT9P2G77YfBgt29",
                    "_blank"
                  )
                }
      ...
      <section className="w-full bg-gradient-to-br from-white to-sky-50 relative overflow-hidden py-10 md:py-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-20 px-6 md:px-8">
          ...
          <div className="w-full md:w-1/2 h-64 md:h-120">
            <Image
              src="/Images/Dentist in Jersey City.webp"
              alt="Emergency treatment at SmileKraft Dental in Jersey City"
              width={600}
              height={400}
          ...
          <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
            <h1 className="text-3xl md:text-5xl font-semibold text-primary leading-tight">
              Dentist in Jersey City, NJ
            </h1>

            <h2 className="text-lg ">
              Complete Dental Care for Families and Individuals Across Jersey City{" "}
            </h2>

            <p className="text-base leading-relaxed">
              SmileKraft Dental delivers advanced family and cosmetic dentistry in Jersey City, NJ.
               Conveniently located on Martin Luther King Drive, our practice serves patients from <strong>Bergen-Lafayette (07304, 07305)</strong>, <strong>McGinley Square (07304, 07306, 07302)</strong>, <strong>Greenville (07305)</strong>, <strong>Journal Square (07306)</strong>, and <strong>The Heights (07306, 07307)</strong>.
      ...
      <section className="w-full bg-gradient-to-br from-white to-sky-50 relative overflow-hidden py-10 md:py-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-20 px-6 md:px-8">
          ...
          <div className="w-full md:w-1/2 h-64 md:h-80">
            <Image
              src="/Images/affordable dental specials.webp"
              alt="New patient special treatment at SmileKraft Dental in Jersey City"
              width={600}
              height={400}
          ...
          <div className="w-full md:w-1/2 text-center md:text-left space-y-4">
            <h2 className="text-3xl md:text-5xl font-semibold text-primary leading-tight">
              Quality Care Within Your Budget
            </h2>

            <p className="text-lg ">
              Worried about dental costs without insurance? At SmileKraft Dental, we make it easier to get the treatment you need. Take advantage of our special offers and flexible payment options:
            </p>
              ...
              <ul className="list-disc gap-3 mt-2 px-6">
                <li className="list-disc">
                  <div className="flex gap-2 ">
                    <span>
                      <strong>$59 Emergency Visit</strong> (Exam & X-ray included)
                    </span>
                  </div>
                </li>
                <li className="list-disc">
                  <div className="flex gap-2">
                    <span>
                      <strong>$89 New Patient Package</strong> (Exam, Cleaning & X-rays)
                    </span>
                  </div>
                </li>
                <li className="list-disc">
                  <div className="flex gap-2">
                    <span>
                      <strong>Interest-Free Financing Plans</strong> (up to 12 Months)
                    </span>
                  </div>
                </li>
                <li className="list-disc">
                  <div className="flex gap-2">
                    <span>
                      {" "}
                      <strong>Reduced Rates</strong> for Seniors during select hours
                    </span>
                  </div>
                </li>
              </ul>
