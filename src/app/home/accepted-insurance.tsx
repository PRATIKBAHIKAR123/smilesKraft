      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-3xl mx-auto leading-relaxed">
            SmileKraft Dental is committed to keeping care within reach by working with most major insurance providers. Unsure about what your plan covers? Our friendly team is here to answer questions and ensure you get the most out of your benefits.        </p>
        </div>
