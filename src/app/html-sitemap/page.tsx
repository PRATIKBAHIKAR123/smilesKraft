...
export default function SitemapPage() {
  ...
  const pages = {
    "Main Pages": [
      { name: "Home", link: "/" },
      { name: "About Us", link: "/about-smilekraft-dental-jerseycity-nj" },
      { name: "Contact Us", link: "/contact-smilekraft-dental-jerseycity-nj" },
      { name: "Blog", link: "/dental-blog" },
      { name: "Reviews", link: "/patient-reviews-jerseycity-nj" },
      { name: "Providers", link: "/providers" },
      { name: "Services", link: "/services" },
      { name: "Offers", link: "/teeth-whitening-offer-jerseycity-nj" },
    ...
    Services: [
      ...
      { name: "Orthodontics", link: "/services/orthodontics-jerseycity-nj" },
      {
      ...
      { name: "Perio Protect", link: "/services/perio-protect-jerseycity-nj" },
      {
        name: "Painless Treatment",
        link: "/services/painless-dental-treatment-jerseycity-nj",
      },
      { name: "Halitosis", link: "/services/halitosis-treatment-jerseycity-nj" },
      { name: "Endodontics", link: "/services/endodontics-jerseycity-nj" },
    ],
    "Service Areas": [
      {
        name: "Maplewood, NJ",
        link: "service-areas/mcginley-square-nj-dentist-near-you",
      },
      {
        name: "South Orange, NJ",
        link: "/service-areas/journal-square-nj-dentist-near-you",
      },
      {
        name: "Irvington, NJ",
        link: "/service-areas/bergenlafayette-nj-dentist-near-you",
      },
      {
        name: "Vauxhall, NJ",
        link: "/service-areas/the-heights-nj-dentist-near-you",
      },
      {
        name: "Newark, NJ",
