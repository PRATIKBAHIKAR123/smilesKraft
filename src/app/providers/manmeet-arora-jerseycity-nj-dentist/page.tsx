  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="details-page-header-section">
        <h1>{doctor.name}</h1>
        <h2>
          Dedicated to Bright, Healthy Smiles for Families Throughout Jersey City
        </h2>
      </div>
