...
const providers = [
  {
    ...
    link: "/providers/manmeet-arora-jerseycity-nj-dentist",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white pb-12">
      ...
      <div className="details-page-header-section">
        <h1> The Professionals Behind Healthy, Confident Smiles in Jersey City, NJ </h1>
        <h2>Experienced Professionals Committed to Your Smile </h2>
      </div>
          ...
          {providers.map((provider, idx) => (
            ...
            >
              <div className="w-full h-2/3 relative min-h-[140px]">
                <Image
                  src={provider.image}
                  alt="Dr. Manmeet Arora D.D.S at SmileKraft Dental in Jersey City"
                  fill
